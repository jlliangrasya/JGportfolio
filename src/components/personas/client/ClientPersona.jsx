        ...
        <section id="cl-work" style={{ padding:'7rem 0',background:'#f0ede6' }}>
          <div className="cl-wrap">
            ...
            <div className="cl-cases reveal">
              {[
                { cat:'FULL-STACK + IoT', badge:'DEPLOYED', badgeCls:'cl-dep', title:'HyPTech — Biometric Management System', body:<>A university needed a complete management system with biometric hardware integration. As <strong>team lead and lead web developer</strong>, I architected the frontend and backend — from React UI to Django APIs to physical sensor communication — driving the group through Agile delivery to a fully deployed system.</>, stack:['REACT','DJANGO','PYTHON','IoT HARDWARE','AGILE'], stat:'Lead', statLbl:'TEAM LEAD + LEAD WEB DEVELOPER' },
