...
export const STATS = [
  ...
  { key: 'xp',    value: 0, color: 'var(--gold)',
    sources: [
      ...
      { title: 'HyPTech + Biometrics',      text: '+1,200 XP — Full-stack + IoT, sole architect, Agile team lead, production deployed' },
...
export const STARS = {
  ...
  builder: {
    ...
    body: 'Not demos — <strong>deployed systems</strong>. HyPTech (biometric, sole architect). XDefender (50% of gameplay, shipped). Barangay tracker (government use). BrightFolks (live ESL SaaS). PesoWise (live finance app). LoadTrack, Cavella, and more. Every project started with a real problem.',
