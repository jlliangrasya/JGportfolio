...
export const STATS = [
  { key: 'tech',  value: 94, color: 'var(--cyan)',
    sources: [
      ...
      { title: 'HyPTech + Biometrics — Team Lead & Lead Dev', text: 'Led a 4-person team as both project lead and lead web developer. Designed the full stack: Django REST backend, React frontend, MySQL database, and hardware bridge to fingerprint sensor.' },
...
export const QUESTS = [
  ...
  { ico: '🛡', name: 'HyPTech + Biometric System', org: 'SLSU Capstone · Jun–Nov 2024 · Team Lead & Lead Web Dev',
    status: 'DEPLOYED', statusClass: 'st-dep', xp: '+1,200 XP',
    desc: '<span>Team lead and lead web developer</span> of a full-stack health tech system with biometric hardware integration. Built the <span>Django REST backend with MySQL database</span>, React frontend with real-time data display, and a hardware bridge to a fingerprint scanner. Led a <span>4-person team</span> through Agile sprints. <span>Deployed to real users at SLSU</span>.',
...
export const ACHIEVEMENTS = [
  ...
  { ico: '🛡',  name: 'Team Lead & Lead Dev — HyPTech',rarityClass: 'epic',     rarity: 'EPIC',      desc: 'Led a 4-person team as both project lead and lead web developer. Built the full-stack system: Django REST backend, MySQL database, React frontend, and biometric hardware integration. Shipped to real users at SLSU.' },
...
export const STARS = {
  leader: {
    ...
    num: 'NORTH STAR', place: 'SLSU · HINUNANGAN · VARIOUS',
    ...
    ctx: 'You have held multiple leadership roles simultaneously: Rotaract Club President (built from ₱0 to ₱30,000 turnover), Vice-President of SLSU-KF21 (revived from disbandment), COMELEC Chairwoman of the College of Engineering, Core Officer of the Supreme Student Council, and Overall Chairwoman of SCUAA 2022. You earned the Scintillate Award for outstanding leadership and service. This star is called NORTH STAR because a north star is the fixed point the sky orients around — constant, reliable, always visible. Leaders are the people others navigate by, and across every org you joined, you became that point.',
  },
  hobbies: {
    label: 'Beyond the Screen', year: 'always', pos: { x: 72, y: 30 }, size: 22, color: '#f472b6',
    num: 'NEBULA', place: 'EVERYWHERE · ALWAYS',
    ...
    ctx: 'Outside of engineering and work, you love dancing, photography, playing instruments, badminton, and used to draw. You are a full person with a rich life beyond code — these hobbies matter to you and have shaped your creativity and discipline. This star is called NEBULA because a nebula is vast, diffuse, and full of color — it doesn\'t compress into a single shape. That\'s what this side of you is: expansive, warm, and not easily defined by a title or a stack.',
  },
  entrepreneur: {
    label: 'The Entrepreneur', year: '2018–present', pos: { x: 27, y: 40 }, size: 32, color: '#fb923c',
    num: 'FIRST SPARK', place: 'HINUNANGAN · ONLINE · VARIOUS',
  ...
  teacher: {
    ...
    ctx: 'You started as an ESL teacher at Cassey International Tutorial Services where you earned Top Tutor recognition — the highest award they give. You went freelance and grew from 1 to 17 students in 2.5 months purely through referrals, with zero advertising. Teaching is outcomes-based for you — same as engineering. This star is called SIGNAL SENT because teaching is transmission — knowledge leaving one person and arriving in another. A signal sent travels outward and multiplies. You sent one signal (one student) and it propagated to seventeen, purely through the quality of what was received.',
  },
  builder: {
    label: 'Engineer & Builder', year: '2024–present', pos: { x: 48, y: 72 }, size: 30, color: '#38bdf8',
    num: 'THE FORGE', place: 'SLSU · RAK SON TECH · XELEQT · EVERYWHERE',
